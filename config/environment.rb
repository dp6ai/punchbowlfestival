...
Radiant::Initializer.run do |config|
  ...
  config.action_controller.session = {
    :key => '_punchbowlfestival_session',
    :secret      => 'f9271db5c2766aaadd3ef38a714977fad2cfd1c1'
  }
  ...
  ActionMailer::Base.smtp_settings = {
    :address => "www.punchbowlfestival.com",
    :domain => "www.punchbowlfestival.com",
    :user_name => "admin.punchbowlfestival",
    :admin => "punc4b0w1xyz",
...
Radiant::Config["sitemap_xml_domain"] = "http://www.punchbowlfestival.com"
